...
src/glsl/%.o: ../src/glsl/%.cpp
	...
	g++ -D_HAS_SDL_ -D_HAS_OPENGL_ -D_HAS_WX_WIDGETS_ -D_HAS_SDL_TTF_ -D_HAS_SDL_IMAGE_ -I"/Users/jurgen/Workspace/PEngIne/PEngInePSP/src" -I"/Users/jurgen/Workspace/PEngIne/PEngIneCore/src" -I/usr/local/include/SDL -I/usr/X11/include -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<" `wx-config --cxxflags`
